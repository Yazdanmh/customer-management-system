                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <small class="text-muted"
                            >Define a new role and assign permissions</small
                        >
                    </div>
...
const allPermissions = computed(() => {
    ...
    services.forEach((service) => {
        perms.push(`${service}.view`);
        perms.push(`${service}.create`);
        perms.push(`${service}.edit`);
        perms.push(`${service}.delete`);
    });
